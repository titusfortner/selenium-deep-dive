...
/**
 * This API is the future No Direct references to DevTools or creating a devtools session Currently
 * implemented with DevTools, but will be replaced with BiDi when available
 */
public class DevToolsAPITest extends TestBase {
  @BeforeEach
  public void setup() {
    startChrome();
  }
