...
public class ProductPage extends BasePage {
  private final Element addToCartButton =
      browser.getElement(By.cssSelector("#add-to-cart"));
  private final Element removeFromCartButton =
      browser.getElement(By.cssSelector("button[data-test^='remove']"));
