...
public class CartPage extends BasePage {
  private final Element checkoutButton =
      browser.getElement(By.cssSelector("button[data-test='checkout']"));
  private final ElementList removeItemButtons =
      browser.getElements(By.cssSelector("button[data-test^='remove-']"));
