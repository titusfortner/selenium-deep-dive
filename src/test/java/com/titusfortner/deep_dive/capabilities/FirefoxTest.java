...
public class FirefoxTest extends BaseTest {
    ...
    /**
     * profile parameter is intended to be for Base64-encoded ZIP of a profile directory
     * primarily for use when running remotely
     * When running locally, use: `{"args": ["-profile", "/path/to/your/profile"]}`
     * Currently FirefoxProfile class has a lot more things it tries to do,
